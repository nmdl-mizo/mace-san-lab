...
1.  "Prediction of the overlap population diagram of organic molecules based on a graph neural network"  
...
1.  "Predicting ELNES/XANES spectra by Machine Learning with Atomic Coordinate-independent Descriptor and Further application to ground state electronic structure"  
...
1.  “Toward the Atomic-Level Analysis of Ground-State Electronic Structures of Solid Materials via Prediction from Core-Loss Spectra: A Computational Study in Si”  
...
1.  “Crystal orbital overlap population based on all-electron ab initio simulation with numeric atom-centered orbitals and its application to chemical-bonding analysis in Li-intercalated layered materials”  
...
1.  “Microscopic chemical characterization of epoxy resin with scanning transmission electron microscopy – electron energy-loss spectroscopy”  
...
1.  “Effect of inorganic material surface chemistry on structures and fracture behaviours of epoxy resin”  
...
1.  “Unraveling the Stability of Layered Intercalation Compounds through First-Principles Calculations: Establishing a Linear Free Energy Relationship with Aqueous Ions”  
    **N. Kawaguchi**, **K. Shibata**, and **T. Mizoguchi**  
    *ACS Physical Chemistry Au*, 4 (2024), 281-291. \[[**here**](https://pubs.acs.org/doi/full/10.1021/acsphyschemau.3c00063)\]

1.  “Lightweight and high-precision materials property prediction using pre-trained Graph Neural Networks and its application to a small dataset”  
...
1. “Combinatorial characterization of metastable luminous silver cations”  
...
1. “Atomistic Probing of Defect-Engineered 2H-MoTe2 Monolayers”  
...
1. “LCAONet: Message-passing with physically optimized atomic basis functions”  
    **K. Nishio**, **K. Shibata** and **T. Mizoguchi**  
    *arXiv preprint arXiv:2402.05634* (2024) \[[**here**](https://arxiv.org/abs/2402.05634)\]

1. “Full automation of point defect detection in transition metal dichalcogenides through a dual mode deep learning algorithm”  
...
1. “A message passing neural network for predicting dipole moment dependent core electron excitation spectra”  
...
1. “Twist-induced interlayer charge buildup in a WS2 bilayer revealed by electron Compton scattering and density functional theory”  
...
1. “Prediction of the Ground State Electronic Structure from Core-loss Spectra of Organic Molecules by Machine Learning”  
    **PY. Chen, K. Shibata**, K. Hagita, T. Miyata, and **T. Mizoguchi**  
...
1. “Possible New Graphite Intercalation Compounds for Superconductors and Charge Density Wave Materials: Systematic Simulations with Various Intercalants Using a van der Waals Density Functional Method”  
    **N. Kawaguchi**, **K. Shibata**, and **T. Mizoguchi**  
...
1. “Tensile strength of a transverse grain boundary in a single-walled carbon nanotube”  
...
1. “A guideline for searching for stable grain boundary structure by utilizing crystallographic information: a method based on non-identical termination”  
...
1. “A defect formation mechanism induced by structural reconstruction of a well-known silicon grain boundary”  
    **YS. Xie**, **K. Shibata**, and **T. Mizoguchi**  
...
1. “STEM-EELSを用いた局所原子配位環境と熱膨張の計測”  
    **溝口照康**，**柴田基洋**  
    *ファインセラミックスレポート*，Vol. 40, No. 4, P146-153.

1. “機能コア解析のためのソフトウェア開発と応用”  
    世古敦人，豊浦和明，**柴田基洋，溝口照康**  
    *まてりあ*，Vol. 61, No. 10, P634-639

1. ” Multimetastability effect on the intermediate stage of phase separation in BaO-SiO2 glass”  
...
1. “Ceramic Science of Crystal Defect Cores”  
...
1. “Quantum Oscillations from Fermi arc Surface States in Cd3As2 Nanowires”  
...
1. “人工知能を利用した界面物性および表面物性の予測”  
    **溝口照康**,**柴田基洋**  
    セラミックデータブック 2021/2022, Vol49, p37-42.

1. “Determination of the Spectrum–structure Relationship by Tree Structure-based Unsupervised and Supervised Learning”  
...
1. “A brute-force code searching for cell of non-identical displacement for CSL grain boundaries and interfaces”  
    **YS. Xie**, **K. Shibata**, and**T. Mizoguchi**  
    *Comp. Phys. Comm.* 273 (2022) 108260-1-8  [**\[here\]**](https://www.sciencedirect.com/science/article/pii/S0010465521003726)

1. “Quantification of the Properties of Organic Molecules Using Core-Loss Spectra as Neural Network Descriptors”  
...
1. “Quantum Deep Descriptor: Physically Informed Transfer Learning from Small Molecules to Polymers”  
...
1. “Robotic fabrication of high-quality lamellae for aberration-corrected transmission electron microscopy”  
...
1. “First principles study on formation and migration energies of sodium and lithium in graphite”,  
...
1. “Accurate prediction of bonding properties by a machine learning–based model using isolated states before bonding”  
...
1. “Revealing Spatial Distribution of Al-Coordinated Species in a Phase-Separated Aluminosilicate Glass by STEM-EELS”  
...
1. “Quantum Deep Field: Data-Driven Wave Function, Electron Density Generation, and Atomization Energy Prediction and Extrapolation with Machine Learning”  
    M. Tsubaki and **T. Mizoguchi**  
    *Phys. Rev. Lett.*, 125 (2020) 206401-1-6. [**\[Open Access\]**](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.125.206401)

1. “In situ observation of the dynamics in the middle stage of spinodal decomposition of a silicate glass via scanning transmission electron microscopy”  
...
1. “Radial distribution function from X-ray absorption near edge structure with an artificial neural network”,  
...
1. “Local thickness and composition measurements from scanning convergent-beam electron diffraction of a binary non-crystalline material obtained by a pixelated detector “  
...
1. “EQCM Analysis of Intercalation Species into Graphite Positive Electrodes for Al Batteries”  
...
1. “Learning excited states from ground states by using an artificial neural network”  
...
1. “Real-Space Mapping of Oxygen Coordination in Phase-Separated Aluminosilicate Glass: Implication for Glass Stability”  
...
1. “Prediction of interface and vacancy segregation energies at silver interfaces without determining interface structures”  
...
1. “EELSと第一原理計算によるエキシトン，原子振動および van derWaals 力の解析”  
    **溝口照康，清原慎**  
...
1. “Machine learning for structure determination and investigating the structure-property relationships of interfaces”  
...
1. “Quantitative estimation of properties from core-loss spectrum via neural network”  
...
1. “Vibrational Effects in X-ray Absorption Spectra of 2D Layered Materials”  
...
1. “Fast and Accurate Molecular Property Prediction: Learning Atomic Interactions and Potentials with Neural Networks”  
    M. Tsubaki and **T. Mizoguchi** 
...
1. “Data-driven approach for the prediction and interpretation of core-electron loss spectroscopy”**  
...
1. “Progress in nanoinformatics and informational materials science”  
    A. Seko, K. Toyoura, S. Muto, **T. Mizoguchi**, S. Broderick, 
    MRS Bulletin*, 43 (2018) 690-695 DOI:10.1557/mrs.2018.206

1. “Identifying lithium K edge anisotropy in LiCoO2”  
    J. Kikkawa, **T. Mizoguchi**, T. Nagai, and K. Kimoto  
    *Physical Review B*, 98 (2018) 075103-1-6 DOI: 10.1103/PhysRevB.98.075103

1. “Identification of nanometer-scale compositional fluctuations in silicate glass using electron microscopy and spectroscopy”  
...
1. “Dissociation Reaction of the 1/3 Edge Dislocation in α-Al2O3”  
...
1. “Bayesian optimization for efficient determination of metal oxide grain boundary structures**“  
...
1. “Transfer Learning to Accelerate Interface Structure Searches”  
...
1. “Basics and Applications of ELNES calculation” **(Invited Review)**  
...
1. “Excitonic, vibrational, and van der Waals interactions in electron energy loss spectroscopy” **(Invited Manuscript)**  
    **T. Mizoguchi**, **T. Miyata**, and W. Olovsson  
    *Ultramicroscopy*, 180 (2017) 93-103. dx.doi.org/10.1016/j.ultramic.2017.03.003

1. “Fabrication of Thin TEM Sample of Ionic Liquid for High-Resolution ELNES Measurements”**  
    **T. Miyata** and **T. Mizoguchi**  
    *Ultramicroscopy*, 178 (2017) 81-87.  doi:10.1016/j.ultramic.2016.10.009

1. “Effect of van der Waals interaction on the electron energy-loss near edge structure theoretical calculation”  
...
1. “A valence state evaluation of a positive electrode material in a Li-ion battery with first-principles K- and L-edge XANES spectral simulations and resonance photoelectron spectroscopy”,
...
1. “Experimental system combined with a micromachine and double-tilt TEM holder”  
...
1. “Effect of van der Waals interactions on the stability of SiC polytypes”  
    **S. Kawanishi** and **T. Mizoguchi**  
    *J. Appl. Phys.* 119 (2016) 175101-1-4. doi:10.1063/1.4948329

1. “Core–Excitonic Interaction in Sodium L2,3 Edge Structure Investigated Using the Bethe-Salpeter Equation”  
    **K. Tomita**, **T. Miyata**, W. Olovsson, and **T. Mizoguchi**  
...
1. “Acceleration of stable interface structure searching using a kriging approach”  
    **S. Kiyohara**, **H. Oda**, K. Tsuda, and **T. Mizoguchi**  
    *Jpn. J. Appl. Phys.*, 55 (2016) 045502-1-4.

1. “Characterization of Vanadium in Oil Sands Fluid Petroleum Coke”  
    **J. E Zuliani**,**T. Miyata**,**T. Mizoguchi**, J. Feng, D. W Kirk, and C. Jia  
    *Fuel*, 178 (2016) 124-128.

1. “First principles calculation of oxygen K edge absorption spectrum of acetic acid: Relationship between the spectrum and molecular dynamics”  
    **Y. Matsui** and **T. Mizoguchi**  
    *Chem. Phys. Lett.*, 649 (2016) 92-96. 

1. “Atomic Structure Characterization of Stacking Faults on the {1-100} Plane in α-Alumina by Scanning Transmission Electron Microscopy”  
...
1. “Investigation of Segregation of Silver at Copper Grain Boundaries by First Principles and Empirical Potential Calculations”  
    **S. Kiyohara** and **T. Mizoguchi**  
...
1. “A new LiNbO3-type polar oxides with closed-shell cations: ZnPbO3”  
     R. Yu, H. Hojo,**T. Mizoguchi** and M. Azuma  
     *J. Appl. Phys.*, 118 (2015) 094103-1-5

1. “Copper accumulation in the sequestrum of medication-related osteonecrosis of the jaw”  
...
1. “Assessment of strain-generated oxygen vacancies using SrTiO3 bicrystals”  
...
1. “Dissociation of the 1/3 Dislocation and Formation of the Anion Stacking Fault on the Basal Plane in α-Al2O3”  
     E. Tochigi, A. Nakamura, **T. Mizoguchi**, N. Shibata, and Y. Ikuhara  
     *Act. Mater*., 91 (2015) 152-161.

1. 「第一原理計算の基礎とEELS 計算への応用」  
     池野豪一，**溝口照康**  
...
1. “Importance of Fermi energy for understanding the intermixing behavior at the LaAlO3/SrTiO3 heterointerface”**  
...
1. 「材料解析におけるELNES/XANES の第一原理計算」   
     **溝口照康**，栃木栄太，柴田直哉，幾原雄一，松永克志  
     まてりあ, 53, No.9 (2014) 414-418.

1. “Impact of local strain on Ti-L2,3 electron energy-loss near-edge structures of BaTiO3: A first-principles multiplet study”   
...
1. “Defect formation energetics at the grain boundary in CuInSe2 using first-principles calculations”   
     **H. Yamaguchi** and **T. Mizoguchi**  
     *J. Ceram. Soc. Jpn*, 122 (2014) 469-472. 

1. “The atomic structure, band gap, and electrostatic potential at the (112)\[1-10\] twin grain boundary of CuInSe2”   
     **H. Yamaguchi**, H. Hiramatsu, H. Hosono, and **T. Mizoguchi**  
     *Appl. Phys. Lett.*, 104, 153904-1-5 (2014). 

1. “Magnetic Structures of FeTiO3-Fe2O3 Solid Solution Thin Films Studied by Soft X-ray Magnetic Circular Dichroism and ab Initio Multiplet Calculations”   
...
1. 「球面収差補正走査透過型電子顕微鏡をもちいたガラス中ドーパントの単原子観察」   
     **溝口照康**  
     NEW GLASS, vol29, No.1 (2014) 23-27

1. “Mn L2,3-edge X-ray absorption spectroscopic studies on charge-discharge mechanism analysis of Li2MnO3”  
     **K. Kubobuchi**, H. Ikeno, M. Mogi, I. Tanaka, H. Imai, and **T. Mizoguchi**  
     *Appl. Phys. Lett.*, 104 (2014) 053906-1-4.   
       
     **—-2013—-**

1. ” High pressure infrared and X-ray Raman studies of aluminum nitride”   
...
1. “Stabilization of metastable ferroelectric Ba12xCaxTi2O5 by breaking Ca-site selectivity via crystallization from glass”   
...
1. “Effect of local coordination of Mn on Mn-L2,3 edge electron energy loss spectrum”   
     S. Nishida, S. Kobayashi, A. Kumamoto, H. Ikeno, **T. Mizoguchi**, I. Tanaka, Y. Ikuhara, T. Yamamoto  
     *J. Appl. Phys.*, 114,(2013)054906-1-6. 

1. “Periodic Nanowire Array at Crystal Interface”   
     A. Nakamura, **T. Mizoguchi**, K. Matsunaga, T. Yamamoto, N. Shibata, and Y. Ikuhara   
     *ACS Nano*, 7 (2013) 6297–6302. 

1. “Atomic Scale Identification of Individual Lanthanide Dopants in Optical Glass Fiber”   
...
1. “The influence of neighboring vacancies and their charge state on the atomic migration of LaAlO3”  
     **T. Yamamoto** and **T. Mizoguchi**  
     *Appl. Phys. Lett.*, 102 (2013) 211910-1-4.

1. “Atomic structure, energetics, and chemical bonding of Y doped Σ13 grain boundaries in α-Al2O3”   
     M. Azuma, N. Shibata, **T. Mizoguchi**, S. D. Findlay, K. Nakamura, and Y. Ikuhara   
     *Phil. Mag.*, 93 (2013) 1158-1171.

1. “First principles study on oxygen vacancy formation in rock salt-type oxides MO (M: Mg, Ca, Sr and Ba)”  
     **T. Yamamoto** and **T. Mizoguchi**   
     *Ceram. Inter.*, 39(2013)S287–S292.   
       
     **–2012–**

1. “Removing the effects of elastic and thermal scattering from electron energy-loss spectroscopic data”   
...
1. “Simultaneous visualization of oxygen vacancies and the accompanying cation shifts in a perovskite oxide by combining annular imaging techniques”  
...
1. “Lithium-ion conducting La2/32xLi3xTiO3 solid electrolyte thin films with stepped and terraced surfaces”  
     H. Ohta, **T. Mizoguchi**, N. Aoki, **T. Yamamoto**, A. Sabarudin, and T. Umemura   
     *Appl. Phys. Lett.*, 100,(2012) 173107-1-4 

1. “Atomic structure of a Σ3 \[110\]/(111) grain boundary in CeO2”  
...
1. “Nanowire of hexagonal gallium oxynitride; direct observation of its stacking disorder and its long nanowire growth”   
     Y. Masubuchi, R. Yamaoka, T. Motohashi, T. Tohei, **T. Mizoguchi**, Y. Ikuhara, and S. Kikkawa   
     *J. Euro. Ceram. Soc.*, 32 (2012) 1989-1993

1. “First principles pseudopotential calculation of electron energy loss near edge structure of lattice imperfections”   
...
1. “Quantitative analyses of oxidation states for cubic SrMnO3 and orthorhombic SrMnO2.5 with electron energy loss spectroscopy”   
     S. Kobayashi, Y. Tokuda, **T. Mizoguchi**, N. Shibata, Y. Sato, Y. Ikuhara and T. Yamamoto   
     *J. Appl. Phys*. vol.108 (2010) 124903-124903-4 

1. “Cr Diffusion in alpha-Al2O3: Secondary Ion Mass Spectroscopy and First-principles Study”  
...
1. “Atomic Structure of a CeO2 Grain Boundary: The Role of Oxygen Vacancies”  
...
1. “Theoretical ELNES: one particle and many particle calculations”**(Invited Review)**  
...
1. “Interface atomic structure of LaCuOSe:Mg epitaxial thin film and MgO substrate”  
...
1. “HAADF-STEM observations of a S13 grain boundary in a-Al2O3 from two orthogonal directions”  
     S. Azuma, N. Shibata, S. D. Findlay, **T. Mizoguchi**, T. Yamamoto, and Y. Ikuhara  
     *Phil. Mag. Lett*. 90 (2010) 539–546

1. “Mechanism of incorporation of zinc into hydroxyapatite”  
     K. Matsunaga, H. Murata, A. Nakahira, and **T. Mizoguchi**  
     *Acta Biomaterialia* 6 (2010) 2289–2293

1. “First-principles sliding simulation of Al-terminated Σ13 pyramidal twin grain boundary in α-Al2O3”  
     K. Nakamura, **T. Mizoguchi**, N. Shibata, K. Matsunaga, T. Yamamoto, and Y. Ikuhara  
     *Phil. Mag. Lett.* 90 (2010) 159-172.

1. “Dissociation Structures of Dislocation and {1-100} Stacking faults of Alumina (a-Al2O3)”  
...
1. “Fabrication of electrically conductive nanowires using high-density dislocations in AlN thin films”  
...
1. “Direct imaging of doped fluorine in LaFeAsO1-xFx superconductor by atomic scale spectroscopy”  
     T. Tohei, **T. Mizoguchi**, H. Hiramatsu, H. Hosono, and Y. Ikuhara  
     *Appl. Phys. Lett. (2009) 95 193107-1-3.*

1. “電子エネルギー損失分光(EELS)と第一原理計算を組み合わせた原子・電子構造解析”  
     **溝口照康**，幾原雄一  
     *セラミックス 9月号 (2009) 702-707*

1. “Atomic-scale segregation behavior of Pr at a ZnO \[0001\] sigma49 tilt grain boundary”  
     Y. Sato, **T. Mizoguchi**, N. Shibata, T. Yamamoto, T. Hirayama, and Y. Ikuhara  
     *Phys. Rev. B, 80 (2009) 094114-1-7.*

1. “Magnetic properties of ilmenite-hematite solid-solution thin films: Direct observation of antiphase boundaries and their correlation with magnetism”  
     H. Hojo, K. Fujita, **T. Mizoguchi**, K. Hirao, I. Tanaka, K. Tanaka, and Y. Ikuhara  
     *Phys. Rev. B., 80 (2009) 075414.*

1. “Transmission electron microscopy and scanning transmission electron microscopy study on B-site cation ordered structures in a (1-x)Pb(Mg1/3Nb2/3)O3-xPbTiO3 single crystal”  
...
1. “First Principles Study on Intrinsic Vacancies in Cubic and Orthorhombic CaTiO3”  
     HS. Lee, **T. Mizoguchi**, T. Yamamoto, and Y. Ikuhara  
     *Mater. Trans. 50 (2009) 977-983.*

1. “First Principles Calculations of Vacancy Formation Energies in s13 Pyramidal Twin Grain Boundary of α-Al2O3”  
     N. Takahashi, **T. Mizoguchi**, T. Tohei, K. Nakamura, T. Nakagawa, N. Shibata, T. Yamamoto, and Y. Ikuhara  
     *Mater. Trans., 50 (2009) 1019-1022.*

1. “Interface Structures of Gold Nanoparticles on TiO2 (110)”  
     N. Shibata, A. Goto, K. Matsunaga, **T. Mizoguchi**, T. Yamamoto, and Y. Ikuhara  
     *Phys. Rev. Lett. 102 (2009) 136105-1-4.*

1. “Excitonic Effects in X-ray Absorption Near Edge Structure From First Principles”  
     W. Olovsson, I. Tanaka, **T. Mizoguchi**, P. Puschnig, and C. Ambrosch-Draxl  
     *Phys. Rev. B., 79 (2009) 041102(R)-1-4.*

1. “3D Shape and Orientation of Nanoscale Pb Inclusions at Grain Boundaries in Al Observed by TEM and STEM Tomography”  
     **T. Mizoguchi** and U. Dahmen  
     *Phil. Mag. Lett., 89 (2009) 104-112.*

1. “First principles calculation of spectral feature, chemical shift, and absolute threshold of ELNES and XANES using plane wave pseudopotential method”  
     **T. Mizoguchi**, I. Tanaka, S Gao, and C.J. Pickard  
     *J. Phys.: Cond. Matter.,21 (2009) 104204-1-6.*

1. “Overlap population diagram for ELNES and XANES: peak assignment and interpretation”  
     **T. Mizoguchi**  
     *J. Phys.: Cond. Matter.,21 (2009) 104215-1-12.*

1. “First principles calculations of XANES and ELNES: present and future”  
     I. Tanaka and **T. Mizoguchi**  
     *J. Phys.: Cond. Matter., 21 (2009) 104201-1-9.*

1. “First principles calculation of oxygen-K electron energy loss near edge structure of HfO2”  
...
1. “Direct observations of Ca ordering in Ca0.33CoO2 thin films with different superstructures”  
     R. Huang, **T. Mizoguchi**, K. Sugiura, H. Ohta, T. Saito, K. Koumoto, T. Hirayama, and Y. Ikuhara  
     *Appl. Phys. Lett., 93 (2008) 181907-1-3.*

1. “Direct Imaging of Reconstructed Atoms on TiO2 (110) Surfaces”  
     N. Shibata, A. Goto, S-Y. Choi, **T. Mizoguchi**, S.D. Findlay, T. Yamamoto and Y. Ikuhara  
     *Science 322 (2008) 570-573.*

1. “HRTEM observation of dislocation structures in AlN thin films”  
     Y. Tokumoto, N. Shibata, **T. Mizoguchi**, M. Sugiyama, Y. Shimogaki, J-S Yang, T. Yamamoto, and Y. Ikuhara  
     *J. Mater. Res. 23 (2008) 2188.*

1. “Site dependence and Peak assignment of YBa2Cu3O7 O-K ELNES”  
     **T. Mizoguchi**, M. Varela, J. P. Buban, T. Yamamoto, and Y. Ikuhara  
     *Phys. Rev. B, 77 (2008) 024504-1-5.*

1. “Atomic Structures of Supersaturated ZnO-Al2O3 Solid Solutions”  
...
1. “Enhanced Seebeck coefficient of quantum confined electrons in the SrTiO3/SrTi0.8Nb0.2O3 superlattices”  
     Y. Mune, H. Ohata, K. Koumoto, **T. Mizoguchi**, and Y. Ikuhara  
     *Appl. Phys. Lett., 91, 192105-1-3 (2007).*

1. “First-principles calculation of defect energetics in cubic-BaTiO3 and a comparison with SrTiO3”  
     H-S. Lee, **T. Mizoguchi**, T. Yamamoto, S-J-L. Kang, and Y. Ikuhara  
     *Act. Mater. 55, (2007) 6535-6540.*

1. “Yttrium doping effect on oxygen grain boundary diffusion in α-Al2O3”  
     T. Nakagawa, I. Sakaguchi, N. Shibata, K. Matsunaga, **T. Mizoguchi**, T. Yamamoto, H. Haneda and Y. Ikuhara  
     *Act. Mater. 55, (2007) 6627-6633.*

1. “ELNESと理論計算を組み合わせた結晶界面の原子・電子構造解析”  
     **溝口照康**，佐藤幸生，松永克志，山本剛久，幾原雄一  
     *顕微鏡, 42(2) (2007) 122-126.*

1. “Grain Boundary Atomic Structures in SrTiO3 and BaTiO3”  
     T. Yamamoto, **T. Mizoguchi**, S.Y. Choi, Y. Sato, N. Shibata, and Y. Ikuhara  
     *Mater. Sci. Forum. 558-559, (2007) 851-856 .*

1. “Direct measurement of titanium pipe diffusion coefficients in sapphire”  
     T.Nakagawa, I. Sakaguchi, N. Shibata, K. Matsunaga, **T. Mizoguchi**, T. Yamamoto, H. Haneda, and Y. Ikuhara  
     *Mater. Sci. Forum. 558-559, 939-942 (2007).*

1. “ELNES，XANES及び理論計算を組み合わせた材料研究と将来展望”  
     **溝口照康**  
     *まてりあ, 46巻6号 (2007) 427-431 .*

1. “First-principles study of grain boundary sliding in a-Al2O3”  
     K. Nakamura, **T. Mizoguchi**, N. Shibata, K. Matsunaga, T. Yamamoto and Y. Ikuhara  
     *Phys. Rev. B.75, (2007) 184109 .*

1. “Theoretical tensile deformation of Σ13 pyramidal twin grain boundary in alumina”  
     K. Nakamura, **T. Mizoguchi**, N. Shibata, K.Matsunaga, T. Yamamoto and Y. Ikuhara  
     *Key. Eng. Mater. 352, 21-24 (2007).*

1. “Multifunctionality in PbVO3 Thin Films”  
...
1. “Atomic structure and relaxation behavior at AlN(0001)/Al2O3(0001) interface”  
...
1. “First principles multi-electron calculations for L2,3 ELNES/XANES of 3d transition metal monoxides”  
     H. Ikeno, **T. Mizoguchi**, Y. Koyama, Y. Kumagai, and I. Tanaka  
     *Ultramicroscopy, 106 (2006) 970-975.*

1. “Role of Pr Segregation in Acceptor-State Formation at ZnO Grain Boundaries”  
     Y. Sato, J. P. Buban, **T. Mizoguchi**, N. Shibata, M. Yodogawa, T. Yamamoto, and Y. Ikuhara  
     *Phys. Rev. Lett. 97 (2006) 106802-1-4*

1. “Bonding nature of metal/oxide incoherent interfaces by first-principles calculations”  
     K. Matsunaga, T. Sasaki, N. Shibata, **T. Mizoguchi**, T. Yamamoto, and Y. Ikuhara  
     *Phys. Rev. B.74 (2006) 125423-1-8*

1. “First-principles study on incident direction, individual site character, and atomic projection dependences of ELNES for perovskite compounds”  
...
1. “Sr vacancy segregation at SrTiO3 grain boundary by heat treatment”  
     **T. Mizoguchi**, Y. Sato, J.P. Buban, K. Matsunaga, T. Yamamoto, and Y. Ikuhara  
     *Appl. Phys. Lett. 87 (2005) 241920-1-3.*

1. “解説：理論計算に基づいたELNESの解釈 II” (Japanese review) **(日本顕微鏡学会和文誌論文賞(2007))**  
     田中 功，**溝口照康**  
     *顕微鏡，40 (2005) 172-175.*

1. “解説：理論計算に基づいたELNESの解釈 I” (Japanese review) **(日本顕微鏡学会和文誌論文賞(2007))**  
     田中 功，**溝口照康**  
     *顕微鏡，40 (2005) 116-119.*

1. “First principles multi-electron calculations of Ni L2,3 NEXAFS/ELNES for LiNiO2 and related compounds”  
     H. Ikeno, I. Tanaka, Y. Koyama, **T. Mizoguchi**, and K. Ogasawara  
     *Phys. Rev. B., 72 (2005) 075123-1-8.*

1. “Arrangement of multiple structural units in ZnO tilt grain boundary”  
     Y. Sato, **T. Mizoguchi**, F. Oba, Y. Ikuhara, and T. Yamamoto  
     *Phys. Rev. B., 72 (2005) 064109-1-7.*

1. “XANES and ELNES in Ceramic Science” **(Most Accessed Article 2005)**  
     I. Tanaka, **T. Mizoguchi**, and T. Yamamoto  
     *J. Am. Ceram. Soc. (Feature article), 88 (2005) 2013-2029.*

1. “Pre-edge fine structures in Ti K-edge X-ray absorption spectra of SrTiO3 and BaTiO3”  
     T. Yamamoto, **T. Mizoguchi**, and I. Tanaka  
     *Phys. Rev. B., 71 (2005) 245113.*

1. “Atomic and electronic structure of \[0001\]/(-1-230) S7 symmetric tilt grain boundary in undoped ZnO bicrystal with linear current-voltage characteristic”  
     Y. Sato, **T. Mizoguchi**, F. Oba, M. Yodogawa, T. Yamamoto, and Y. Ikuhara  
     *J. Mater. Sci., 40 (2005) 3059.*

1. “Electronic Structure of Lithium Nickel Oxides by Electron Energy Loss Spectroscopy”  
     Y. Koyama, **T. Mizoguchi**, H. Ikeno, and I. Tanaka  
     *J. Phys. Chem. B, 109 (2005) 10749*

1. “Characterization of nano-textured AlN thin films by X-ray absorption near edge structures (XANES)”  
     T. Suga, S. Kameyama, S. Yoshioka, T. Yamamotoa, I. Tanaka, and **T. Mizoguchi**  
     *Appl. Phys. Lett., 86 (2005) 163113.*

1. “解説：ELNESの理論解析” (Japanese review)  
     **溝口照康**，田中 功  
     *日本結晶学会誌 47 (2005) 73.*

1. “Distribution of solute atoms in b- and spinel- SiAlONs by Al-K x-ray absorption near edge structures”  
     K. Tatsumi, **T. Mizoguchi**, S. Yoshioka, T. Yamamoto, T. Suga, T. Sekine, and I. Tanaka  
     *Phys. Rev. B, 71 (2005) 033202.*

1. “電子線エネルギー損失スペクトルを用いたCu/Al2O3(0001)界面の局所化学結合状態解析”  
     佐々木健夫，**溝口照康**，松永克志，田中真悟，山本剛久，香山正憲，幾原雄一  
     *日本金属学会誌，69 (2005) 86.*

1. “First-Principles Calculations of Titanium Dopants in Alumina”  
     K. Matsunaga, **T. Mizoguchi**, A. Nakamura, T. Yamamoto, and Y. Ikuhara  
     *Materials Science Forum, 475-479 (2005) 3095.*

1. “Atomic and electronic structures of Cu/sapphire interfaces by HRTEM and EELS analyses”  
     T. Sasaki, **T. Mizoguchi**, K. Matsunaga, S. Tanaka, T. Yamamoto, M. Kohyama and Y. Ikuhara  
     *Materials Science Forum, 475-479 (2005) 3859.*

1. “Theoretical and experimental Ti-K NEXAFS of various Ti-oxides”  
...
1. “First-principles calculations of ELNES/XANES of selected wide-gap materials: Dependence on crystal structure and orientation”  
     **T. Mizoguchi**, I. Tanaka, S. Yoshioka, M. Kunisu, T. Yamamoto, and W. Y. Ching  
     *Phys. Rev. B, 70 (2004) 45103.*

1. “Si 基板上に形成した Al2O3 薄膜の ELNES 解析”  
     **溝口照康**，木本浩司，田中 功  
     *まてりあ 43 (2004). *

1. “First-principles calculation of L3 x-ray absorption near edge structures (XANES) and electron energy loss near edge structures (ELNES) of GaN and InN polymorphs”  
     **T. Mizoguchi**, T. Yamamoto, T. Suga, M. Kunisu, I. Tanaka, and H. Adachi  
     *Materials Transactions, 45 (2004) 2023.*

1. “Theoretical investigation of Al K-edge X-ray absorption spectra of Al, AlN and Al2O3”  
     M. Mogi,T. Yamamoto, **T. Mizoguchi**, K. Tatsumi, S. Yoshioka, S. Kameyama, I. Tanaka, and H. Adachi  
     *Materials Transactions, 45 (2004) 2031.*

1. “First principles study of core-hole effect on fluorine K-edge X-ray absorption spectra of MgF2 and ZnF2”  
...
1. “X-ray Absorption Near Edge Structures of Silicon Nitride Thin Film by Pulsed Laser Deposition”  
     T. Suga, **T. Mizoguchi**, M. Kunisu, K. Tatsumi, T. Yamamoto, I. Tanaka, and T. Sekine  
     *Materials Transactions, 45 (2004) 2039.*

1. “Identification of Native Defects around Grain Boundary in Pr-doped ZnO Bicrystal using ELNES and First-principles Calculations”  
     Y. Sato, **T. Mizoguchi**, F. Oba, M. Yodogawa, T. Yamamoto, and Y. Ikuhara  
...
1. “Formation of titanium-solute clusters in alumina: A first-principles study”  
     K. Matsunaga, **T. Mizoguchi**, A. Nakamura, T. Yamamoto, and Y. Ikuhara  
...
1. “Theoretical prediction of ELNES/XANES and chemical bondings of AlN polytypes”  
     **T. Mizoguchi**, I. Tanaka, M. Kunisu, M. Yoshiya, H. Adachi and W. Y. Ching  
     *Micron, 34 (2003) 249.*

1. “解説：電子線エネルギー損失スペクトルの理論計算による解釈”  
     **溝口照康**，田中 功，足立裕彦  
     *まてりあ, 42 (2003) 207-213.*

1. “Coordination and interface analysis of atomic-layer-deposition Al2O3 on Si(001) using energy-loss near-edge structures”  
...
1. “Defect and electronic structure of TiSi2 thin films produced by co-sputterings. part II: chemical bonding and electron energy-loss near-edge structures”  
     **T. Mizoguchi**, I. Tanaka, M. Mizuno, H. Adachi T. Hashimoto, H. Inui and M. Yamaguchi  
     *Act. Mater. ,49 (2001) 2321.*

1. “Defect and electronic structure of TiSi2 thin films produced by co-sputterings. part I: defect analysis by transmission electron microscopy”  
